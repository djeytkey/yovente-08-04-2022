            ...
            <div class="main-menu">
                <ul id="side-main-menu" class="side-menu list-unstyled">
                    ...
                    <li><a href="<?php echo e(url('/')); ?>"> <i
                                class="dripicons-meter"></i><span><?php echo e(__('file.dashboard')); ?></span></a></li>
                    <?php
                        ...
                        <li><a href="#purchase" aria-expanded="false" data-toggle="collapse"> <i
                            ...
                            <ul id="purchase" class="collapse list-unstyled ">
                                <li id="purchase-list-menu"><a
                                        href="<?php echo e(route('purchases.index')); ?>"><?php echo e(trans('file.Purchase List')); ?></a>
                                </li>
                                <?php
                                $add_permission = DB::table('permissions')
                        ...
                        <li><a href="#quotation" aria-expanded="false" data-toggle="collapse"> <i
                            ...
                            <ul id="quotation" class="collapse list-unstyled ">
                                <li id="quotation-list-menu"><a
                                        href="<?php echo e(route('quotations.index')); ?>"><?php echo e(trans('file.Quotation List')); ?></a>
                                </li>
                                <?php
                                $add_permission = DB::table('permissions')
                        ...
                        <li><a href="#transfer" aria-expanded="false" data-toggle="collapse"> <i
                            ...
                            <ul id="transfer" class="collapse list-unstyled ">
                                <li id="transfer-list-menu"><a
                                        href="<?php echo e(route('transfers.index')); ?>"><?php echo e(trans('file.Transfer List')); ?></a>
                                </li>
                                <?php
                                $add_permission = DB::table('permissions')
                            ...
                            <ul id="people" class="collapse list-unstyled ">
                                ...
                                <?php if($biller_index_permission_active): ?>
                                    <li id="biller-list-menu"><a
                                            href="<?php echo e(route('biller.index')); ?>"><?php echo e(trans('file.Biller List')); ?></a>
                                    </li>
                                    <?php
                            ...
                            <ul id="report" class="collapse list-unstyled ">
                                ...
                                <?php if($best_seller_active): ?>
                                    <li id="best-seller-report-menu">
                                        <a
                                            href="<?php echo e(url('report/best_seller')); ?>"><?php echo e(trans('file.Best Seller')); ?></a>
                                    </li>
                                <?php endif; ?>
                                ...
                                <?php if($product_qty_alert_active): ?>
                                    <li id="qtyAlert-report-menu">
                                        <a
                                            href="<?php echo e(route('report.qtyAlert')); ?>"><?php echo e(trans('file.Product Quantity Alert')); ?></a>
                                    </li>
                                <?php endif; ?>
                    ...
                    <li><a href="#setting" aria-expanded="false" data-toggle="collapse"> <i
                        ...
                        <ul id="setting" class="collapse list-unstyled ">
                            ...
                            <?php if($brand_permission_active): ?>
                                <li id="brand-menu"><a
                                        href="<?php echo e(route('brand.index')); ?>"><?php echo e(trans('file.Brand')); ?></a></li>
                            <?php endif; ?>
                            ...
                            <?php if($currency_permission_active): ?>
                                <li id="currency-menu"><a
                                        href="<?php echo e(route('currency.index')); ?>"><?php echo e(trans('file.Currency')); ?></a></li>
                            <?php endif; ?>
                    ...
                    <span class="brand-big">
                        <?php if($general_setting->site_logo): ?>
                            <a href="<?php echo e(url('/')); ?>"><img
                                    src="<?php echo e(url('public/logo', $general_setting->site_logo)); ?>" width="115"></a>
                        <?php else: ?>
                    ...
                    <ul class="nav-menu list-unstyled d-flex flex-md-row align-items-md-center">
                        ...
                        <li class="nav-item">
                            ...
                            <ul class="dropdown-menu edit-options dropdown-menu-right dropdown-default" user="menu">
                                <li>
                                    <a href="<?php echo e(url('language_switch/ar')); ?>" class="btn btn-link"> العربية</a>
                                </li>
                                <li>
    ...
    <div class="page">
        ...
        <footer class="main-footer">
            <div class="container-fluid">
                <div class="row">
                    <div class="col-sm-12">
                        <p><?php echo e(date('Y')); ?> &copy; <?php echo e($general_setting->site_title); ?> |
                            <?php echo e(trans('file.Developed')); ?> <?php echo e(trans('file.By')); ?> <span
...
<?php /**PATH D:\laragon\www\yovente-08-04-22\resources\views/layout/main.blade.php ENDPATH**/ ?>