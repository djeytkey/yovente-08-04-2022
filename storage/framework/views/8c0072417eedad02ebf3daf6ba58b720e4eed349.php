                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="row">
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            ...
                                            <p><strong><?php echo e(strtolower(Auth::user()->name) . '-' . date("dmy") . '-'. date("His")); ?></strong></p>
                                            <input type="hidden" name="reference_no" class="form-control" value="<?php echo e(strtolower(Auth::user()->name) . '-' . date("dmy") . '-'. date("His")); ?>"/>
                                        </div>
                                    ...
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" name="customer_name" id="customer_name" placeholder="<?php echo e(trans('file.Customer name...')); ?>" required>
                                        </div>
                                    </div>
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            <label><?php echo e(trans('file.Telephone')); ?> *</label>
                                            <input type="tel" pattern="0[0-9]{9}" class="form-control" name="customer_tel" id="customer_tel" placeholder="<?php echo e(trans('file.Customer telephone...')); ?>" required>
                                        </div>
                                    </div>
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            <label><?php echo e(trans('file.City')); ?> *</label>
                                            <select required name="customer_city" id="customer_city" class="selectpicker form-control" data-live-search="true" title="<?php echo e(trans('file.Select city...')); ?>">
                                                <?php $__currentLoopData = $lims_cities_list; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $city): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <option value="<?php echo e($city->id); ?>">$city->cities</option>
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <textarea class="form-control rounded-0" name="customer_address" id="customer_address" rows="3"></textarea>
                                        </div>
                                    </div>
                                </div>
                                <div class="row mt-3">
                                ...
                                <div class="row">
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            <label class="mt-2" style="color: red"><strong><?php echo e(trans('file.Confirmed')); ?> ?</strong></label>
...
<?php echo $__env->make('layout.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\laragon\www\yovente-08-04-22\resources\views/sale/create.blade.php ENDPATH**/ ?>