    ...
    <div class="hidden-print">
        <table>
            <tr>
                ...
                <td><a href="<?php echo e(url()->previous()); ?>" class="btn btn-info"><i class="fa fa-arrow-left"></i> <?php echo e(trans('file.Back')); ?></a> </td>
    ...
    <div id="receipt-data">
        <div class="centered">
            <?php if($general_setting->site_logo): ?>
                <img src="<?php echo e(url('public/logo', $general_setting->site_logo)); ?>" width="150" style="margin:10px 0;/*filter: brightness(0);*/">
            <?php endif; ?>
        ...
        <p><?php echo e(trans('file.Date')); ?>: <?php echo e(date(config('date_format'), strtotime($lims_sale_data->created_at->toDateString()))/*date($lims_sale_data->created_at)*/); ?><br>
            ...
            <tbody>
                ...
                <tr>
                    <td colspan="2">
                        ...
                        <br><small><?php echo e($product_sale_data->qty); ?> x <?php echo e(number_format((float)($product_sale_data->total / $product_sale_data->qty), 2, '.', '')); ?></small>
        ...
        <div class="centered" style="margin:30px 0 50px">
            <small><?php echo e($general_setting->site_title); ?> &copy; <?php echo e(date("Y")); ?></strong></small>
        </div>
    </div>
</div>
...
<?php /**PATH D:\laragon\www\yovente-08-04-22\resources\views/sale/invoice.blade.php ENDPATH**/ ?>