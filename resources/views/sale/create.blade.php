            ...
            <div class="col-md-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        {!! Form::open(['route' => 'sales.store', 'method' => 'post', 'files' => false, 'class' => 'payment-form']) !!}
                        <div class="row">
                            <div class="col-md-12">
                                <div class="row">
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            ...
                                            <p><strong>{{ strtolower(Auth::user()->name) . '-' . date("dmy") . '-'. date("His") }}</strong></p>
                                            <input type="hidden" name="reference_no" class="form-control" value="{{ strtolower(Auth::user()->name) . '-' . date("dmy") . '-'. date("His") }}"/>
                                        </div>
                                    ...
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" name="customer_name" id="customer_name" placeholder="{{ trans('file.Customer name...') }}" required>
                                        </div>
                                    </div>
                                    <div class="col-md-3">
                                        <div class="form-group">
                                    ...
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            ...
                                            <select required name="customer_city" id="customer_city" class="selectpicker form-control" data-live-search="true" title="{{ trans('file.Select city...') }}">
